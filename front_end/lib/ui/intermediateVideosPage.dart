...
class IntermediateVideosPage extends StatefulWidget {
  final Map<String, dynamic>? userData;
  final String? userId;

  const IntermediateVideosPage({
    super.key,
    this.userData,
    this.userId,
  });
  ...
  @override
  State<IntermediateVideosPage> createState() => _IntermediateVideosPageState();
}

class _IntermediateVideosPageState extends State<IntermediateVideosPage> {
  ...
  int _totalIntermediateVideos = 0;
  ...
  // Metode untuk mengambil data video intermediate dari Firestore
  Future<void> _fetchIntermediateVideos() async {
    ...
    try {
      ...
      print('Intermediate videos count: ${videosSnapshot.docs.length}');
      ...
      if (videosSnapshot.docs.isNotEmpty) {
        ...
        setState(() {
          ...
          _totalIntermediateVideos = tempList.length;
          _isLoading = false;
        });
        
        print('Successfully loaded ${_intermediateVideos.length} videos');
      } else {
        print('No intermediate videos found in Firestore');
        setState(() {
          _isLoading = false;
        });
      }
    ...
    try {
      if (!_watchedVideos.contains(videoId)) {
        setState(() {
          ...
          for (int i = 0; i < _intermediateVideos.length; i++) {
            if (_intermediateVideos[i]['id'] == videoId) {
              _intermediateVideos[i]['isWatched'] = true;
              break;
            }
          }
        });
        ...
        if (_userLevel == 'intermediate') {
          ...
          if (newProgress >= _totalIntermediateVideos) {
            await _upgradeToAdvanced();
          } else {
  ...
  // Upgrade user to advanced level and reset progress
  Future<void> _upgradeToAdvanced() async {
    if (_userId == null) return;
  ...
  // Show level upgrade dialog when user completes all intermediate videos
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text(
                'You have completed all intermediate level videos and have been upgraded to:',
              ),
              const SizedBox(height: 12),
              Container(
              ...
              const SizedBox(height: 12),
              const Text(
                'You can now access advanced level content, and you can still watch intermediate videos anytime!',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.grey,
                ),
          ...
          children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _userLevel == 'advanced' ? Colors.purple : const Color(0xFF2C5530),
                  ...
                  if (_userLevel == 'intermediate')
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Progress: $_progressLevel/$_totalIntermediateVideos videos completed',
                            style: const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
                              color: Color(0xFF2C5530),
                          ...
                          LinearProgressIndicator(
                            value: _totalIntermediateVideos > 0 
                                ? _progressLevel / _totalIntermediateVideos 
                                : 0.0,
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'You are now at advanced level! You can still access and review intermediate videos anytime.',
                              style: TextStyle(
                                color: Colors.purple.shade800,
                                fontSize: 14,
                              ),
            ...
            Expanded(
              child: _isLoading
                  ...
                  : _intermediateVideos.isEmpty
                      ? const Center(
                          child: Text(
                            'No intermediate videos available',
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 16,
                            ),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final video = _intermediateVideos[index];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          const Text(
                            'This is an intermediate level yoga tutorial video. Follow along at your own pace and remember to listen to your body.',
                            style: TextStyle(
                              fontSize: 14,
