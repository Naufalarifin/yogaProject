...
class AdvancedVideosPage extends StatefulWidget {
  final Map<String, dynamic>? userData;
  final String? userId;

  const AdvancedVideosPage({
    super.key,
    this.userData,
    this.userId,
  });
  ...
  @override
  State<AdvancedVideosPage> createState() => _AdvancedVideosPageState();
}

class _AdvancedVideosPageState extends State<AdvancedVideosPage> {
  ...
  // Metode untuk mengambil data video advanced dari Firestore
  Future<void> _fetchAdvancedVideos() async {
    ...
    try {
      ...
      print('Advanced videos count: ${videosSnapshot.docs.length}');
      ...
      if (videosSnapshot.docs.isNotEmpty) {
        ...
        setState(() {
          ...
          _totalAdvancedVideos = tempList.length;
          _isLoading = false;
        });
        
        print('Successfully loaded ${_advancedVideos.length} videos');
      } else {
        print('No advanced videos found in Firestore');
        setState(() {
          _isLoading = false;
        });
      }
    ...
    try {
      if (!_watchedVideos.contains(videoId)) {
        setState(() {
          ...
          for (int i = 0; i < _advancedVideos.length; i++) {
            if (_advancedVideos[i]['id'] == videoId) {
              _advancedVideos[i]['isWatched'] = true;
              break;
            }
          }
        });
        ...
        if (_userLevel == 'advanced') {
          ...
          if (newProgress >= _totalAdvancedVideos) {
  ...
  // Show completion dialog when all advanced videos are watched
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'You have completed all advanced level videos! '
            'You\'ve mastered all the yoga classes available.',
          ),
          actions: [
            TextButton(
          ...
          children: [
                  ...
                  if (_userLevel == 'advanced')
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Progress: $_progressLevel/$_totalAdvancedVideos videos completed',
                            style: const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
                              color: Color(0xFF2C5530),
                          ...
                          LinearProgressIndicator(
                            value: _totalAdvancedVideos > 0 
                                ? _progressLevel / _totalAdvancedVideos 
                                : 0.0,
            ...
            Expanded(
              child: _isLoading
                  ...
                  : _advancedVideos.isEmpty
                      ? const Center(
                          child: Text(
                            'No advanced videos available',
                            style: TextStyle(
                              color: Colors.grey,
                              fontSize: 16,
                            ),
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final video = _advancedVideos[index];
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'This is an advanced level yoga tutorial video. Follow along at your own pace and remember to listen to your body.',
                            style: TextStyle(
                              fontSize: 14,
